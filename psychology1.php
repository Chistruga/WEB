...
<div class="col-md-9">
    <div class="col-md-3">
            ...
            <a href="psihologia.html"> <img class="card-img-top" src="img\psychology\2211.jpg" alt="Card image cap"></a>
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Kenneth Strong</li>
            ...
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\1067720.1-testarea-psihologica.png" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Testarea psihologică</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Nicolae Mitrofan</li>
                      <li class="st3 list-group-item">MDL 130.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
            <br>
    ...
    <div class="col-md-3">
            ...
            <a href="antreneaza.html"><img class="card-img-top" src="img\psychology\antreneaza-ti-creierul-strategii-si-tehnici-de-transformare-mentala_1_fullsize.jpg" alt="Card image cap"></a>
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Joe Dispenza</li>
            ...
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\carte_liderul-poti-fi-tu-editia-a-ii-a-revizuita_19195c.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Liderul poți fi tu</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Dale Carnegie</li>
                      <li class="st3 list-group-item">MDL 210.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
    ...
    <div class="col-md-3">
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\consumul-si-dependenta-de-droguri-ghid-practic-de-evaluare_-diagnostic-si-tratament-arthur-w.blume.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title">Consumul și dependența de droguri</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Arhur Blume</li>
                      <li class="st3 list-group-item">MDL 135.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\copertafata_50_.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title">Nu lăsa cancerul să te învingă<br></h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Sophie Sabbage</li>
    ...
    <div class="col-md-3">
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\distruge-ti_obiceiurile_nocive_cop_1.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title">Distruge-ți obiceiurile nocive</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Joe Dispenza</li>
            ...
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\psychology\suicidul_in_romania.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Suicidul în România</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Adina Demian</li>
                      <li class="st3 list-group-item">MDL 200.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
