...
<div class="col-md-9">
    <div class="col-md-3">
            ...
            <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Petr Berka</li>
            ...
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\travel\9781400015863.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Rome<br><br></h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Fodors</li>
    ...
    <div class="col-md-3">
            ...
            <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Nick Yapp</li>
                      <li class="st3 list-group-item">MDL 200.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\travel\9789731155753-1712331-240.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title">Ghidul călătorului român</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Mihai Scarlat</li>
    ...
    <div class="col-md-3">
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\travel\berlin_1333802846.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Ghid turistic Berlin</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Fodors</li>
            ...
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\travel\destinatii-de-top-atena_1_produs.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Destinații de top Atena</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Acrina Dispoere</li>
    ...
    <div class="col-md-3">
            <br>
            <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="img\travel\egipt---ghid-turistic_1_fullsize.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="st1 card-title"><br>Egipt Ghid turistic</h5>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">K. H. Beck</li>
                      <li class="st3 list-group-item">MDL 210.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
            ...
            <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                      <li class="st2 list-group-item">Louis James</li>
                      <li class="st3 list-group-item">MDL 200.00</li>
                      <li class="st3 list-group-item"> <a href="#" class="st4 card-link">ADD</a></li>
                    </ul>
            </div>
