...
<body>
    ...
    <div class="row">
            <div class="col-md-4">
                        <a href="index.php"><img src="img/logo1.png" class="img-responsive center-block h-auto w-75" style="padding-top:1em;">
                        </a>
                        </div>
            <div class="col-md-4" style="padding-top:75px;">
                        <div id="custom-search-input">
                                        <div class="input-group col-md-12">
                                            <input type="text" class="form-control input-lg" placeholder="caută" />
            ...
            <div class="col-md-4" style="text-align:center;">
                    <div class="row" style="padding-left:25px;">
                                ...
                                <a href="index.php"><img src="img/buy.png" class="d-inline img-responsive center-block imagine"></a>
                                <a href="index.php"><img src="img/lang.png" class="d-inline img-responsive center-block imagine"></a>
    ...
    <div class="row">
        <div class="col-md-12">
            <nav class="text-nowrap bg-light" style="text-align:center;">
                    <a href="#" class="text-secondary pr-md-3">ACASĂ</a>
                    <a href="#" class="text-secondary pr-md-3">DESPRE NOI</a>
                    <a href="products.html" class="text-secondary pr-md-3">CĂRȚI</a>
                    <a href="form.html" class="text-secondary pr-md-3">CHESTIONAR</a>
            </nav>
        </div>  
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
               <a href="twilight.html"> <img src="img/book1.jpg" alt="..." class=" border border-secondary rounded"></a>
        </div>
        <div class="col-md-4">
                <a href="tremetri.html"><img src="img/book2.jpg" alt="..." class=" border border-secondary rounded"></a>
        </div>
        <div class="col-md-4">
                <a href="ThinkAndGrow.html"><img src="img/book3.jpg" alt="..." class=" border border-secondary rounded"></a>
        </div>
            </div>
    </div>
    <hr style=" border: 3px solid rgb(50, 93, 129)">
    <h3 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; text-align: center; color: rgb(50, 93, 129); font-weight:bold;">PRODUSE NOI</h3>
    <hr style=" border: 3px solid rgb(50, 93, 129)">
    <div class="row" style="padding-bottom:40px;">
        <div class="col-md-12">
                <div class="col-md-3">
                       <a href="perfectGirl.html"> <img src="img/n1.jpg" class=" border border-secondary rounded w-75"></a>
                </div>
                <div class="col-md-3">
    ...
    <hr style=" border: 3px solid rgb(50, 93, 129)">
    <h3 style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; text-align: center; color: rgb(50, 93, 129); font-weight:bold;">REDUCERE <SPAN style="color:red">50%</SPAN></h3>
    <hr style=" border: 3px solid rgb(50, 93, 129)">
<div class="row" style="padding-bottom:40px;">
    <div class="col-md-12">
        <div class="col-md-3">
        <a href="micul.html"> <img class="card-img-top" src="img\history\balcic.-micul-paradis-al-rom_niei-mari3.jpg" alt="Card image cap"></a></div>
        <div class="col-md-3">
...
while ($row = mysqli_fetch_assoc($find_counts))
{
    ...
    echo "<h1 style='color: grey; font-weight:bold; text-align:center; font-family:Times New Roman;'>".$new_count."</h1>";
}
?>
        </div>
</div>
    ...
    <div class="row ffo bg-light">
        ...
        <!--https://www.rosegal.com/promotion/black-friday-sale.html?lkid=409449&gclid=EAIaIQobChMIq_PPjJDk3gIVFYuyCh2oxgtqEAAYASAAEgKpfvD_BwE-->
            <div class="col-md-4">
                   <h6><b>Informații</b></h6><br>
                   <a href="https://www.amazon.in/gp/help/customer/display.html/ref=footer_privacy?ie=UTF8&nodeId=200534380">Politica de Confidențialitate</a><br>
                   <a href="https://www.amazon.in/gp/help/customer/display.html/ref=footer_cou?ie=UTF8&nodeId=200545940">Termeni și condiții</a><br>
                   <a href="url">Probleme de securitate</a><br>
            </div>
            <div class="col-md-4">
                    <h6><b>Servicii CONSUMATOR</b></h6><br>
                    <a href="https://support.google.com/store/answer/6160267?hl=en">Metode de plată</a><br>
                    <a href="https://www.amazon.com/gp/help/customer/display.html?nodeId=201845220">Garanții și Returnări</a><br>
                    <br>
                    <br>
                    <br>
